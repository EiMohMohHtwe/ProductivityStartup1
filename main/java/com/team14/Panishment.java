...
public class Panishment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("တားမြစ်ချက်နှင့် ပြစ်ဒဏ်များ");
